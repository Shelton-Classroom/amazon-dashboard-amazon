...
namespace WebAppDashboard.Areas
{
    public class NewInventoriesController : Controller
    {
        ...
        // GET: NewInventories/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: NewInventories/Create
